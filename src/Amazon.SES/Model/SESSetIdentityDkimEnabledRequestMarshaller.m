...
+ (AmazonServiceRequest *)createRequest:(SESSetIdentityDkimEnabledRequest *)setIdentityDkimEnabledRequest {
    ...
    [request setEndpoint:[setIdentityDkimEnabledRequest requestEndpoint]];
    [request setRequestTag:[setIdentityDkimEnabledRequest requestTag]];

    if (setIdentityDkimEnabledRequest != nil) {
        if (setIdentityDkimEnabledRequest.identity != nil) {
            [request setParameterValue:[NSString stringWithFormat:@"%@", setIdentityDkimEnabledRequest.identity] forKey:[NSString stringWithFormat:@"%@", @"Identity"]];
        }
    }
    if (setIdentityDkimEnabledRequest != nil) {
