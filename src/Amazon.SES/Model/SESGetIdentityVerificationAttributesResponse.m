...
@implementation SESGetIdentityVerificationAttributesResponse
...
- (NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"VerificationAttributes: %@,", verificationAttributes]];
