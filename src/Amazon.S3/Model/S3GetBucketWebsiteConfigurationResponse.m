...
@implementation S3GetBucketWebsiteConfigurationResponse
...
-(void)processBody
{
    ...
    S3GetBucketWebsiteConfigurationResultUnmarshaller *unmarshaller = [[S3GetBucketWebsiteConfigurationResultUnmarshaller alloc] init];
