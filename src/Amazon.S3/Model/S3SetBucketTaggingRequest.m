...
{
    return [[[S3SetBucketTaggingRequest alloc] initWithBucketName:theBucketName withConfiguration:theConfiguration] autorelease];
}

+(id)requestWithBucketName:(NSString *)theBucketName
{
    return [[[S3SetBucketTaggingRequest alloc] initWithBucketName:theBucketName withConfiguration:nil] autorelease];
}
