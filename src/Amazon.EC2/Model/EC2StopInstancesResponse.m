...
@synthesize stoppingInstances;


- (id)init {
    if (self = [super init]) {
        stoppingInstances = [[NSMutableArray alloc] initWithCapacity:1];
    }
...
- (NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"StoppingInstances: %@,", stoppingInstances]];
