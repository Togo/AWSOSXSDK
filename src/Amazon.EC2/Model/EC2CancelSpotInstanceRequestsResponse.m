...
@implementation EC2CancelSpotInstanceRequestsResponse
...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"CancelledSpotInstanceRequests: %@,", cancelledSpotInstanceRequests]];
