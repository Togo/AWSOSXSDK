...
@implementation ElasticLoadBalancingSetLoadBalancerPoliciesForBackendServerRequest
...
-(NSString *)description
{
    ...
    [buffer appendString:[[NSString alloc] initWithFormat:@"PolicyNames: %@,", policyNames]];
