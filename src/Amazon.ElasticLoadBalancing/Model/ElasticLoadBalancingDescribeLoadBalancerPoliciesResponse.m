...
@implementation ElasticLoadBalancingDescribeLoadBalancerPoliciesResponse
...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"PolicyDescriptions: %@,", policyDescriptions]];
