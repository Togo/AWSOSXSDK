...
@implementation AutoScalingDescribeAutoScalingGroupsRequest
...
- (NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"AutoScalingGroupNames: %@,", autoScalingGroupNames]];
