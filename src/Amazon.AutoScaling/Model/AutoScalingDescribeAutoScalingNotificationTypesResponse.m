...
@implementation AutoScalingDescribeAutoScalingNotificationTypesResponse
...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"AutoScalingNotificationTypes: %@,", autoScalingNotificationTypes]];
