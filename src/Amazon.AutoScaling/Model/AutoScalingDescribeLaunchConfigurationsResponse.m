...
@implementation AutoScalingDescribeLaunchConfigurationsResponse

@synthesize launchConfigurations;
...
{
    if (self = [super init]) {
        launchConfigurations = [[NSMutableArray alloc] initWithCapacity:1];
        nextToken            = nil;
    }
...
-(NSString *)description
{
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"LaunchConfigurations: %@,", launchConfigurations]];
