...
@implementation AutoScalingDescribeAutoScalingGroupsResponse

@synthesize autoScalingGroups;
@synthesize nextToken;


- (id)init {
    if (self = [super init]) {
        autoScalingGroups = [[NSMutableArray alloc] initWithCapacity:1];
        nextToken = nil;
    }
...
- (NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"AutoScalingGroups: %@,", autoScalingGroups]];
