...
@implementation AutoScalingDescribePoliciesResponse

@synthesize scalingPolicies;
@synthesize nextToken;


- (id)init {
    if (self = [super init]) {
        scalingPolicies = [[NSMutableArray alloc] initWithCapacity:1];
        nextToken = nil;
    }
...
- (NSString *)description {
    ...
    [buffer appendString:@"{"];
    [buffer appendString:[[NSString alloc] initWithFormat:@"ScalingPolicies: %@,", scalingPolicies]];
