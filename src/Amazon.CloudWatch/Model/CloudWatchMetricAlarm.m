...
-(NSString *)description
{
    ...
    [buffer appendString:[[NSString alloc] initWithFormat:@"AlarmConfigurationUpdatedTimestamp: %@,", alarmConfigurationUpdatedTimestamp]];
    ...
    [buffer appendString:[[NSString alloc] initWithFormat:@"StateReasonData: %@,", stateReasonData]];
    [buffer appendString:[[NSString alloc] initWithFormat:@"StateUpdatedTimestamp: %@,", stateUpdatedTimestamp]];
