...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
    ...
    if ([elementName isEqualToString:@"DeleteMessageBatchResultEntry"]) {
        [parser setDelegate:[[SQSDeleteMessageBatchResponseEntryUnmarshaller alloc] initWithCaller:self withParentObject:self.response.successful withSetter:@selector(addObject:)]];
    }
